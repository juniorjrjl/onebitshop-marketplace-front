...
const Chats = [
    {
        ...
        messages: [
            ...
            {
                _id: "9",
                content:"Muito obrigado pela sua atenção. Entrarei em contato em breve. Até mais!",
            ...
            {
                _id: "8",
                content: "Claro, sem problemas! Se tiver mais alguma dúvida, por favor, não hesite em me contatar. Obrigado pelo seu interesse no PlayStation 5!",
            ...
            {
                _id: "7",
                content: "Compreendo. Eu ainda estou interessado, mas preciso pensar um pouco mais. Posso entrar em contato com você novamente em alguns dias?",
            ...
            {
                _id: "6",
                content: "Desculpe, mas esse é o preço final. O PlayStation 5 é um produto de alta qualidade e oferece uma experiência de jogo incrível que vale cada centavo do investimento.",
            ...
            {
                _id: "5",
                content: "Isso é um pouco fora do meu orçamento. Há algum desconto disponível?",
            ...
            {
                _id: "2",
                content: "Olá, claro! O PlayStation 5 é o console de última geração da Sony. Ele possui processador AMD Zen 2 personalizado e GPU RDNA 2 personalizada, além de 16 GB de RAM GDDR6. O console também vem com uma unidade de armazenamento interno SSD ultra-rápida de 825 GB, que permite tempos de carregamento quase instantâneos. Ele também é compatível com jogos de PlayStation 4 e oferece suporte para jogos em 4K a 120fps, Ray Tracing, HDR e muito mais. O que mais você gostaria de saber?",
                createdAt: "19-04-2023",
                receiver: "buyer",
                sender: "seller",
            },
            {
                _id: "1",
                content: "Olá, gostaria de saber mais informações sobre o PlayStation 5.",
...
const ChatList = () => {
    const renderItem: ListRenderItem<any> = ({item}) => <ChatCard item={item}/>
